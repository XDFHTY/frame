...
public class RabbitMQConfig {
    /** 消息交换机的名字*/
    public static final String EXCHANGE = "rmq-exchange";
    /** 队列key1*/
    ...
    public ConnectionFactory connectionFactory() {
        CachingConnectionFactory connectionFactory = new CachingConnectionFactory("192.168.0.109",5672);
    ...
    @Bean
    public Queue queue2() {
        return new Queue("queue_tow", true); //队列持久
